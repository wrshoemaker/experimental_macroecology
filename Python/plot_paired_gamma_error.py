...
ax_survival = plt.subplot2grid((1, 3), (0,1), colspan=1)
ax_comparison = plt.subplot2grid((1, 3), (0,2), colspan=1)

ax_occupancy.text(-0.1, 1.04, plot_utils.sub_plot_labels[0], fontsize=10, fontweight='bold', ha='center', va='center', transform=ax_occupancy.transAxes)
ax_survival.text(-0.1, 1.04, plot_utils.sub_plot_labels[1], fontsize=10, fontweight='bold', ha='center', va='center', transform=ax_survival.transAxes)
ax_comparison.text(-0.1, 1.04, plot_utils.sub_plot_labels[2], fontsize=10, fontweight='bold', ha='center', va='center', transform=ax_comparison.transAxes)
...
ax_comparison.set_ylabel('Occupancy relative error, transfer 12', fontsize=12)
