...
ax_scatter_no_migration = plt.subplot2grid((2, 2), (0, 0))#, colspan=1)
ax_scatter_global_migration = plt.subplot2grid((2, 2), (0, 1))#, colspan=1)

ax_width_no_migration = plt.subplot2grid((2, 2), (1, 0))#, colspan=1)
ax_width_global_migration = plt.subplot2grid((2, 2), (1, 1))#, colspan=1)
